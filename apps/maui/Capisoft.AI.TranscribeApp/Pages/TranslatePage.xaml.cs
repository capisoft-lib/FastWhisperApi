...
public partial class TranslatePage : ContentPage
{
    ...
    {
        var items = await _historyService.GetByModeAsync("translate");
        _history.Clear();
    ...
    private async void OnRecordReleased(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            var path = await SaveRecordingAsync(audioSource, "translate");
            var text = await _apiService.SendAudioAsync("translate", path);
    ...
    private async void OnClearClicked(object sender, EventArgs e)
    {
        ...
        await _historyService.ClearModeAsync("translate");
        _history.Clear();
    }
